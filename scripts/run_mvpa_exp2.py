#!/usr/bin/env python
"""
Run MVPA analysis for Experiment 2
"""
import argparse
from pathlib import Path
import pandas as pd
from analysis.mvpa.decoders import Experiment2Decoder

def main():
    parser = argparse.ArgumentParser(description='Run Experiment 2 MVPA analysis')
    ...
    if args.output:
        ...
        # Default output name
        output_path = f"exp2_results_{args.subject}_{args.roi}.csv"
